...
CLASSIFICATIONS = {
 'Developer-obtainable credential route': [2,3,4,5,7,9,10,11,12,14,15,17,19,20,22,26,27,28,29,32,34,35,36,39,41,43,46,47,48,49,50,51,52,53,54,57,60,61,62,65,66,67,68,70,71,72,73,74,75,76,79,80,81,82,87,88,91,92,93,95,99],
 'Paid plan / entitlement / usage gate': [1,2,21,35,47,52,53,60,87,90,92,94,96,99],
 'Admin / permissions / authorization gate': [1,2,4,10,15,17,20,26,28,36,41,43,44,48,49,53,55,57,61,67,68,74,75,76,81,87,88,91,96],
 'App review / provider access approval': [12,14,28,29,31,33,35,38,53,72],
